...
clf_config = LightGBMConfig(
    model_name="LightGBM_Iris",
...
clf_model = CustomLightGBM(config=clf_config)
...
reg_config = LightGBMConfig(
    model_name="LightGBM_Diabetes",
...
reg_model = CustomLightGBM(config=reg_config)
