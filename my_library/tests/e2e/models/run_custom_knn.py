...
# configure CustomKNN for classification
clf_config = KNNConfig(
    model_name="CustomKNN_Iris",
...
clf_model = CustomKNN(config=clf_config)
...
# configure CustomKNN for regression
reg_config = KNNConfig(
    model_name="CustomKNN_Diabetes",
...
reg_model = CustomKNN(config=reg_config)
